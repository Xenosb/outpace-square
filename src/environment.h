...
const char mainQmlFile[] = "qrc:/qt/qml/View/App.qml";
const char serviceQmlFile[] = "qrc:/qt/qml/View/Service.qml";
...
Q_IMPORT_QML_PLUGIN(QtQuick_Studio_DesignEffectsPlugin)
...
inline void set_qt_environment() {
    ...
    qputenv("QT_QUICK_CONTROLS_CONF", ":/view/qtquickcontrols2.conf");
}
